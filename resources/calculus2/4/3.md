...
<iframe width="560" height="315" src="https://www.youtube.com/embed/vKPEEnxLHV8" frameborder="0" allowfullscreen></iframe>

- The equation \\(r=R\\) is a circle centered at the origin of radius
  \\(R\\).
- The equation \\(r=D\cos\theta\\) is the circle with diameter \\(D\\)
  tangent to the \\(y\\)-axis at the origin.
- The equation \\(r=D\sin\theta\\) is the circle with diameter \\(D\\)
